...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_control_servos_0_2_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_servos_slave_lite_v3_0_S00_AXI is
  ...
  signal clkCounter_reg : STD_LOGIC_VECTOR ( 31 downto 4 );
  ...
  signal \clkCounter_reg_n_0_[2]\ : STD_LOGIC;
  signal \clkCounter_reg_n_0_[3]\ : STD_LOGIC;
  ...
  signal pwm_left_i_22_n_0 : STD_LOGIC;
  ...
  signal \NLW_clkCounter1_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
clkCounter1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => '0',
      DI(0) => clkCounter1_carry_i_3_n_0,
      O(3 downto 0) => NLW_clkCounter1_carry_O_UNCONNECTED(3 downto 0),
      S(3) => clkCounter1_carry_i_4_n_0,
      S(2) => clkCounter1_carry_i_5_n_0,
      S(1) => clkCounter1_carry_i_6_n_0,
      S(0) => clkCounter1_carry_i_7_n_0
    );
\clkCounter1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \clkCounter1_carry__0_i_1_n_0\,
      O(3 downto 0) => \NLW_clkCounter1_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \clkCounter1_carry__0_i_2_n_0\,
      S(2) => \clkCounter1_carry__0_i_3_n_0\,
      S(1) => \clkCounter1_carry__0_i_4_n_0\,
      S(0) => \clkCounter1_carry__0_i_5_n_0\
    );
\clkCounter1_carry__0_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\clkCounter1_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\clkCounter1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_clkCounter1_carry__2_CO_UNCONNECTED\(3 downto 2),
      CO(1) => clkCounter1,
      CO(0) => \clkCounter1_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => clkCounter_reg(31),
      DI(0) => '0',
      O(3 downto 0) => \NLW_clkCounter1_carry__2_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => \clkCounter1_carry__2_i_1_n_0\,
      S(0) => \clkCounter1_carry__2_i_2_n_0\
    );
...
clkCounter1_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
clkCounter1_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
clkCounter1_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
pwmCnt1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => pwmCnt1_carry_i_1_n_0,
      DI(1) => pwmCnt1_carry_i_2_n_0,
      DI(0) => pwmCnt1_carry_i_3_n_0,
      O(3 downto 0) => NLW_pwmCnt1_carry_O_UNCONNECTED(3 downto 0),
      S(3) => pwmCnt1_carry_i_4_n_0,
      S(2) => pwmCnt1_carry_i_5_n_0,
      S(1) => pwmCnt1_carry_i_6_n_0,
      S(0) => pwmCnt1_carry_i_7_n_0
    );
...
pwm_left_i_17: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
pwm_left_i_22: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
pwm_left_reg_i_12: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => pwm_left_i_17_n_0,
      DI(0) => pwm_left_i_18_n_0,
      O(3 downto 0) => NLW_pwm_left_reg_i_12_O_UNCONNECTED(3 downto 0),
      S(3) => pwm_left_i_19_n_0,
      S(2) => pwm_left_i_20_n_0,
      S(1) => pwm_left_i_21_n_0,
      S(0) => pwm_left_i_22_n_0
    );
...
\pwm_right0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \pwm_right0_carry__2_i_1_n_0\,
      S(2) => \pwm_right0_carry__2_i_2_n_0\,
      S(1) => \pwm_right0_carry__2_i_3_n_0\,
      S(0) => \pwm_right0_carry__2_i_4_n_0\
    );
...
\pwm_right0_carry__2_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
pwm_right0_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
pwm_right0_carry_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
pwm_stable0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => pwm_stable0_carry_i_1_n_0,
      DI(1) => '0',
      DI(0) => pwm_stable0_carry_i_2_n_0,
      O(3 downto 0) => NLW_pwm_stable0_carry_O_UNCONNECTED(3 downto 0),
      S(3) => pwm_stable0_carry_i_3_n_0,
      S(2) => pwm_stable0_carry_i_4_n_0,
      S(1) => pwm_stable0_carry_i_5_n_0,
      S(0) => pwm_stable0_carry_i_6_n_0
    );
...
pwm_stable0_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_control_servos_0_2,control_servos,{}";
